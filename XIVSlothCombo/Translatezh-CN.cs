...
public class Translatezh_CN
{
    ...
    public static Dictionary<string, string> db = new()
    {
        ...
        {"Adds Enshroud to the combo when at 50 Shroud or greater and when current target is afflicted with Death's Design.","当目标有死亡烙印Debuff并且魂衣大于50时，将夜游魂衣加入连击。"},
        ...
        {"Lemure's Slice Option","夜游魂切割/钐割设置"},
        {"Adds Lemure's Slice to the combo when there are 2 Void Shroud charges.","当有2层虚无魂时将夜游魂切割/钐割加入连击。"},
