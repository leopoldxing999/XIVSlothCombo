...
public class Translatezh_CN
{
    ...
    public static Dictionary<string, string> db = new()
    {
        ...
        {"Air Anchor followed by Drill is added onto main combo if you use Reassemble.\nIf Air Anchor is on cooldown and you use Reassemble, Chain Saw will be added to main combo instead.","空气锚 followed by 钻头 is added onto main combo if you use 整备.\nIf 空气锚 is on cooldown and you use Reassemble, 回转飞锯 will be added to main combo instead."},
