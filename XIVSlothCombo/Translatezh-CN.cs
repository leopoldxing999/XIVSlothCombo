...
public class Translatezh_CN
{
    ...
    public static Dictionary<string, string> db = new()
    {
        ...
        {"Simple AoE Feature","黑魔AoE技能一键循环"},
        ...
        {"Thunder 1/3 Option","闪雷/暴雷 设置"},
        {"Replaces Scathe with Thunder 1/3 when the debuff isn't present or expiring.","等待翻译"},
        {"Simple BLM Feature","黑魔单体技能一键循环：模式一"},
        {"Replaces Scathe with a full one button rotation.","整合一键单体技能循环至崩溃."},
        {"CDs Option","等待翻译"},
        {"Ley Lines Option","等待翻译"},
        {"Triplecast / Swiftcast Option","等待翻译"},
        {"Pool Triplecast / Swiftcast Option","保留瞬发 设置"},
        {"Keep one triplecast usage and swiftcast for movement in the Simple BLM feature.","保留即刻咏唱和一层三连咏唱用于移动时瞬发技能."},
        {"Pool Xenoglossy Option","等待翻译"},
        {"Fire 3 Opener","爆炎起手 设置"},
        {"Adds the Fire 3 Opener to Simple BLM.","使用爆炎作为起手技能."},
        {"Fire 3 Opener - 1 Triplecast","爆炎起手三连咏唱 设置"},
        {"Modifies the Simple Fire 3 Opener to only use 1 Triplecast.","爆炎起手中只使用一层三连咏唱."},
        {"Foul / Manafont Flare Option","秽浊/魔泉 核爆 设置"},
        ...
        {"Advanced BLM Feature","黑魔单体技能一键循环：模式二"},
        {"Replaces Scathe with a full one button rotation that uses Transpose. Requires level 90.","整合单体技能循环至崩溃，期间使用星灵移位进行极性切换.需要黑魔法师达到90级."},
        {"Pool Triplecast Option","保留三连咏唱 设置"},
        {"Keep one triplecast usage for movement in the Advanced BLM feature.","保留一层三连咏唱用于移动时瞬发技能."},
        {"Paradox BLM Feature","黑魔单体技能一键循环：模式三"},
        {"Replaces Scathe with a full one button rotation that has minimal casts (~9-13%% less damage than Simple BLM). Requires level 90.","整合单体技能循环至崩溃,此种循环包含最少的读条技能(但相较简易循环可能输出会下降9%到13%).需要黑魔法师达到90级."},
        {"Adds Ley Lines onto the Advanced BLM feature.","在循环中插入黑魔纹"},
        {"Adds Ley Lines onto the Paradox BLM feature.","在异言中插入黑魔纹"},
        {"Swiftcast/Triplecast Moving Option","移动时瞬发技能设置"},
        {"Use Swiftcast/Triplecast when moving.","移动时自动插入即刻咏唱/三连咏唱瞬发技能."},
        {"Xenoglossy Moving Option","异言设置"},
        {"Use Xenoglossy when moving.","移动时自动插入异言."},
        {"Scathe Moving Option","崩溃设置"},
