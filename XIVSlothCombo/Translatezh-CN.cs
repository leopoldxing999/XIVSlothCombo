...
public class Translatezh_CN
{
    public static Dictionary<string, string> db = new()
    {
        ...
        {"Simple Bard Feature","等待翻译"},
        {"Adds every single target ability to one button,\nIf there are DoTs on target, Simple Bard will try to maintain their uptime.","等待翻译"},
        ...
        {"This option adds the Bard's Songs to the Simple Bard Feature.","等待翻译"},
        {"Songs Feature","等待翻译"},
        ...
        {"One Button Songs Feature","等待翻译"},
        {"Add Mage's Ballad and Army's Paeon to Wanderer's Minuet depending on cooldowns.","等待翻译"},
        {"Simple AoE Bard Feature","等待翻译"},
        ...
        {"Disable Apex Arrow Feature","等待翻译"},
        ...
        {"Second Wind Option","等待翻译"},
        {"Uses Second Wind when below set HP percentage.","等待翻译"},
        #endregion
        #region DANCER
        ...
        {"Simple Saber Dance Option","等待翻译"},
        {"Includes Saber Dance in the rotation when at or over the Esprit threshold.","等待翻译"},
        ...
        {"Throwing Dagger Uptime Option","等待翻译"},
        ...
        {"Delayed Trick Attack Option","等待翻译"},
        {"Waits at least 8 seconds into combat before using Trick Attack.","进入战斗至少8s后再使用 攻其不备"},
        {"Ninjitsu Option","等待翻译"},
        {"Adds Ninjitsu to Advanced Mode.","等待翻译"},
        ...
        {"Ten Chi Jin to Meisui Feature","等待翻译"},
        ...
        {"Huraijin / Armor Crush Combo Feature","等待翻译"},
        ...
        {"Adds True North before Armor Crush when you are not in the correct position for the enhanced potency bonus.","等待翻译"},
        #endregion
        #region PALADIN
        ...
        {"Level 90 Opener Option","等待翻译"},
        {"Adds the Level 90 Opener to the main combo. Choose which Opener to use below.","等待翻译"},
        #endregion
        ...
        {"Dynamic True North Feature","等待翻译"},
        ...
        {"Weaves Lucid Dreaming when your MP drops below the specified value.","等待翻译"},
        {"Eukrasian Dosis Option","均衡注药 设置"},
        {"Automatic DoT Uptime.","自动插入均衡注药续Dot."},
        {"Movement Options","等待翻译"},
        {"Use selected instant cast actions while moving.","等待翻译"},
        {"Phlegma Option","等待翻译"},
        {"Use Phlegma if available and within range.","等待翻译"},
        ...
        {"Weaves Lucid Dreaming when your MP falls below the specified value.","等待翻译"},
        #endregion
        ...
        {"Adds Shinten to the main combo when Kenki > 25 and your current target is below the HP percentage threshold.","等待翻译"},
        #endregion
        #endregion
        ...
        #endregion
        #region WARRIOR
        {"Storm's Path Combo Feature","等待翻译"},
        ...
        {"Storm's Eye Combo Feature","等待翻译"},
        {"Replace Storm's Eye with its combo chain.","等待翻译"},
        {"Overpower Combo Feature","等待翻译"},
        {"Add combos to Overpower.","等待翻译"},
        {"Warrior Gauge Overcap Option","等待翻译"},
        {"Replace Single target or AoE combo with gauge spender if you are about to overcap and are before a step of a combo that would generate Beast gauge.","等待翻译"},
        {"Nascent Flash Feature","原初的勇猛"},
        {"Replace Nascent Flash with Raw intuition when level synced below 76.","等待翻译"},
        {"Upheaval Option","等待翻译"},
        {"Adds Upheaval into maincombo if you have Surging Tempest.","等待翻译"},
        {"Primal Rend Option","蛮荒崩裂"},
        {"Replaces Inner Beast and Steel Cyclone with Primal Rend when available (also added onto main AoE combo).","等待翻译"},
        {"Orogeny Option","等待翻译"},
        {"Adds Orogeny onto main AoE combo when you are buffed with Surging Tempest.","等待翻译"},
        ...
        {"Onslaught Option","等待翻译"},
        {"Adds Onslaught to Storm's Path feature combo if you are under Surging Tempest Buff.","等待翻译"},
        {"Infuriate AoE Option","等待翻译"},
        {"Adds Infuriate to AoE combo when gauge is below 50 and not under Inner Release.","在兽魂不低于50的时候将战壕加入AOE连击."},
        {"Inner Release AoE Option","等待翻译"},
        {"Adds Inner Release to Storm's Path combo.","将原初的解放加入到暴风斩连击"},
        {"Tomahawk Uptime Option","等待翻译"},
        {"Replace Storm's Path Combo Feature with Tomahawk when you are out of range.","在如果离boss太远，将飞斧加入到暴风斩连击."},
        {"Infuriate on Fell Cleave / Decimate Feature","等待翻译"},
        {"Turns Fell Cleave and Decimate into Infuriate if at or under set rage value.","等待翻译"},
