...
namespace XIVSlothCombo.Window
{
    ...
    internal class ConfigWindow : Dalamud.Interface.Windowing.Window, IDisposable
    {
        ...
        public ConfigWindow() : base("XIVSlothCombo配置", ImGuiWindowFlags.AlwaysAutoResize)
        {
        ...
        public void DrawConfig()
        {
            ...
            if (ImGui.Begin("XIVSlothCombo配置", ref visible))
            {
                if (ImGui.BeginTabBar("配置栏"))
                {
                    if (ImGui.BeginTabItem("PvE功能"))
                    {
                        PvEFeatures.Draw();
                        ImGui.EndTabItem();
                    }

                    if (ImGui.BeginTabItem("PvP功能"))
                    {
                        PvPFeatures.Draw();
                        ImGui.EndTabItem();
                    }
                    ...
                    if (ImGui.BeginTabItem("关于XIVSlothCombo/反馈"))
                    {
                        AboutUs.Draw();
                        ImGui.EndTabItem();
                    }
